...
public class InventaireServiceImpl implements InventaireService {
     ...
     */
    public static synchronized InventaireServiceImpl getInstance() {
        if (instance == null) {
    ...
    public boolean transfererDuCoffreVersInventaire(Joueur joueur, int itemId) {
        ...
        try {
            ...
            boolean suppressionReussie = coffreDAO.supprimerItemDuCoffre(joueur.getPseudo(), itemId);
    ...
    public boolean transfererDeInventaireVersCoffre(Joueur joueur, int itemId) {
        ...
        try {
            ...
            boolean ajoutReussi = coffreDAO.ajouterItemAuCoffre(joueur.getPseudo(), itemATrouver);
            ...
            if (!suppressionReussie) {
                ...
                coffreDAO.supprimerItemDuCoffre(joueur.getPseudo(), itemId);
