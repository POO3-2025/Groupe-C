...
public class CoffreMongoDAOImpl implements CoffreMongoDAO {
    ...
    public List<Item> obtenirItemsDuCoffre(String pseudo) {
        try {
            ...
            Coffre coffre = obtenirCoffreParJoueurId(joueur.getId());
            
            if (coffre == null) {
                System.err.println("Coffre non trouvé pour le joueur: " + pseudo);
                return List.of();
            }
            
            // Extraire les items du coffre
            ...
            System.out.println("Items trouvés dans le coffre de " + pseudo + ": " + items.size());
            return items;
        } catch (Exception e) {
    ...
    public boolean supprimerItemDuCoffre(String pseudo, int itemId) {
        try {
            ...
            return retirerItemDuCoffre(joueur.getId(), itemId, 1); // Supprime un exemplaire de l'item
        } catch (Exception e) {
